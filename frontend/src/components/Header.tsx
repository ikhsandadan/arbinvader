                ...
                <Toolbar className='flex place-items-center'>
                    ...
                    {isConnected && (
                        <Box sx={{ display: { xs: 'none', sm: 'block' } }} className="flex space-x-2 place-items-center ml-6">
                            {pages.map((page) => (
                                <button key={page.name} className={`font-semibold px-4 bg-[#091a1f] hover:border hover:rounded-full hover:px-6 py-2 rounded-full ${currentPage === page.name ? 'bg-[#f5f5f5] text-[#091a1f]' : 'hover:bg-[#f5f5f5] hover:text-[#091a1f]'}`}>
